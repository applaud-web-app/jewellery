    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Blog Categories</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard/">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-blog-category">Blog Categories</a></li>
                    </ol>
                </div>
            </div>
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                ...
                <div class="d-flex align-items-center flex-wrap">
                    <a href="{{url('admin/add-blog-category')}}" class="btn btn-primary  mb-2"><i class="fas fa-plus pe-2"></i>Add New
                        Blog Categories</a>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table display text-black" id="example5">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="wspace-no">
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex align-items-center ps-2">
                                                            <h4 class="my-1 ps-1">{{$cat->name}}</h4>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="wspace-no d-flex">{!! substr($cat->description,0,20)!!} ....</td>
                                                <td class="wspace-no">{{$cat->total_blog_count}}</td>
                                                <td class="wspace-no">
                                                    @if($cat->status==1)
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $inputObj->params = 'id='.$cat->id;
                                                        $inputObj->url = url('admin/remove-blog-category');
                                                        $encLink = Common::encryptLink($inputObj);

                                                        $inputObjE = new stdClass();
                                                        $inputObjE->params = 'id='.$cat->id;
                                                        $inputObjE->url = url('admin/edit-blog-category');
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5"><h4 class="text-center text-danger">NO BLOG CATEGORIES FOUND</h4></td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="w-100 mt-3 num_pagination">
                                    {{$blogCatgeory->appends(request()->input())->links('pagination')}}
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        $("#search_btn").on('click',function(){
            ...
            if(txt!=''){
                window.location.href = "{{url('admin/search-blog-category?q=')}}"+txt;
            }
        })
    </script>
@endpush
