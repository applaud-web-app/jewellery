    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Add Blog Category</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard/">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-blog-category">All Blogs</a></li>
                        <li class="breadcrumb-item active"><a href="/admin/add-blog-category">Add Blog Category</a></li>
                    </ol>
                </div>
            </div>
            <form action="{{url('admin/store-blog-catgeory')}}" class="position-relative" id="product_frm" name="product_frm" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cat_title" id="cat_title" placeholder="Enter Product name" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="content">Catgeory Description <span class="text-danger">*</span></label>
                                            <textarea name="cat_description" id="content" class="my_tinyeditor" style="height: 400px;"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
