    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Add Blogs</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-blogs">Blogs</a></li>
                        <li class="breadcrumb-item active"><a href="{{url()->full()}}">Add Blogs</a></li>
                    </ol>
                </div>
            </div>
            <form action="{{url('admin/store-blog')}}" class="position-relative" id="product_frm" name="product_frm" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="blog_title" id="blog_title" placeholder="Enter Product name" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="blog_description" id="content" class="my_tinyeditor" style="height: 400px;" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-lg-12 col-12">
                                        ...
                                        <textarea style="height:100px" class="form-control" id="description" name="meta_description" placeholder="Enter description" ></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
