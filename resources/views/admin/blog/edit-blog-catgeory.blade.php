    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Edit Blog Category</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard/">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-blog-category">All Blogs</a></li>
                        <li class="breadcrumb-item active"><a href="{{url()->full()}}">Edit Blog Category</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cat_title" value="{{$blogCatgeory->name}}" id="cat_title" placeholder="Enter Product name" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="content">Catgeory Description <span class="text-danger">*</span></label>
                                            <textarea name="cat_description" id="content" class="my_tinyeditor" style="height: 400px;">{{$blogCatgeory->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 ">
                        <button type="submit" class="btn btn-primary  mb-2"><i
                            ...
                            <a href="{{url('admin/all-blog-category')}}" class="btn btn-dark  mb-2"><i class="far fa-window-close pe-2"></i>Cancel</a>
                    </div>
                </div>
            </form>
        </div>
