    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Edit Blogs</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-blogs">Blogs</a></li>
                        <li class="breadcrumb-item active"><a href="{{url()->full()}}">Edit Blogs</a></li>
                    </ol>
                </div>
            </div>
            <form action="{{$updateLink}}" class="position-relative" id="product_frm" name="product_frm" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="blog_title" id="blog_title" placeholder="Enter Product name" value="{{$blogs->title}}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="blog_catgeory">Blog Category <span class="text-danger">*</span></label>
                                            <select name="blog_catgeory" id="blog_catgeory"  class="form-file-input form-control" required>
                                                <option value="" selected disabled>Select Blog Category</option>
                                                @foreach ($blogCatgeory as $cat)
                                                    <option value="{{$cat->id}}" {{$blogs->blogcategory_id == $cat->id ? "selected":"" }}>{{$cat->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                     <div class="mb-3 col-lg-12 col-12">
                                        ...
                                        <div class="input-group">
                                            <div class="form-file">
                                                <input type="file" data-id="2" name="blog_image" id="blog_image"  onchange="loadFilePrev(event)"  class="form-file-input form-control" required>
                                            </div>
                                        </div>
                                        <img src="/uploads/blog/{{$blogs->image}}" id="img_prev_2" alt="img" style="height:210px;width:auto;">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="content">Description <span class="text-danger">*</span></label>
                                            <textarea name="blog_description" id="content" class="my_tinyeditor" style="height: 400px;" required>{{$blogs->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="card h-auto">
                            <div class="card-header">
                                <h5 class="card-title">Blog SEO</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-lg-12 col-12">
                                        <label for="meta_title">Meta Title</label>
                                        <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="Enter meta title" value="{{$blogs->seoDetails->meta_title}}" >
                                        <input type="hidden" value="{{$blogs->seoDetails->id}}" name="seo_id">
                                    </div>
                                    <div class="mb-3 col-lg-12 col-12">
                                        <label for="keyword">Meta Keywords</label>
                                        <input type="text" class="form-control" id="keyword" name="keyword" value="{{$blogs->seoDetails->meta_keywords}}" placeholder="Enter keyword" >
                                    </div>
                                    <div class="mb-3 col-lg-12 col-12">
                                        <label for="description">Meta Description</label>
                                        <textarea style="height:100px" class="form-control" id="description" name="meta_description" placeholder="Enter description" >{{$blogs->seoDetails->meta_description}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 ">
                        <button type="submit" class="btn btn-primary  mb-2"><i
                            ...
                            <a href="{{url('admin/all-blogs')}}" class="btn btn-dark  mb-2"><i class="far fa-window-close pe-2"></i>Cancel</a>
                    </div>
                </div>
            </form>
        </div>
