                ...
                <div class="col-xl-6">
                    <div class="row">
                        <div class="col-xl-6 col-sm-6">
                            <div class="card">
                                <a href="/admin/all-products" class="card-body d-flex align-items-center justify-content-between">
                                    <div class="menu">
                                    ...
                                    <div class="d-inline-block position-relative donut-chart-sale">
                                        <span class="donut1"
                                            data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'></span>
                        ...
                        <div class="col-xl-6 col-sm-6">
                            <div class="card">
                                <a href="/admin/all-orders" class="card-body d-flex align-items-center justify-content-between">
                                    <div class="menu">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-header border-0 flex-wrap pb-0">
                            ...
                            <div>
                                <h2 class="font-w700 mb-0">₹{{$todayRevenue}}</h2>
                                <p class="mb-0 font-w700"><span class="text-success">₹{{$currentMonthRevenue}}</span></p>
                            </div>
                        </div>
