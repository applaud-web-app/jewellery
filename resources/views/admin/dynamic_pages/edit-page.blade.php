    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Edit Page</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard/">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-pages/">Blogs</a></li>
                        <li class="breadcrumb-item active"><a href="{{url()->full()}}">Edit Page</a></li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter Page Title" value="{{$page->title}}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-6 mb-3">
                                        <div class="form-group">
                                            <label for="slug">Page Slug <span class="text-danger">*</span></label>
                                            <input type="text" value="{{$page->slug}}" class="form-control" name="slug" id="slug" placeholder="Enter Page Slug">
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="content">Page Description <span class="text-danger">*</span></label>
                                            <textarea name="description" id="content" class="my_tinyeditor" style="height: 400px;">{{$page->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
