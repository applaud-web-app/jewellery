    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Add FAQ</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-faq">FAQ</a></li>
                        <li class="breadcrumb-item active"><a href="/admin/add-faq">Add FAQ</a></li>
                    </ol>
                </div>
            </div>
            <form action="{{url('admin/add-faq')}}" class="position-relative" id="product_frm" name="product_frm" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('question')}}"  class="form-control" name="question" id="question" placeholder="Enter Question" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="slug">Answer </label>
                                            <textarea name="answer" id="answer" class="form-control" cols="30" rows="40" placeholder="Enter Answer" required>{{old('answer')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 ">
                        <button type="submit" class="btn btn-primary  mb-2"><i
                            ...
                            <a href="{{url('admin/all-faq')}}" class="btn btn-dark  mb-2"><i class="far fa-window-close pe-2"></i>Cancel</a>
                    </div>
                </div>
            </form>
        </div>
