    ...
    <section class="content-body">
        ...
        <div class="container-fluid">
            <div class="mb-sm-3 d-flex flex-wrap align-items-center text-head">
                <h2 class="mb-3 me-auto">Edit FAQ</h2>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                        <li class="breadcrumb-item"><a href="/admin/all-faq">FAQ</a></li>
                        <li class="breadcrumb-item active"><a href="{{url()->full()}}">Edit FAQ</a></li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="question" id="question" placeholder="Enter Question" value="{{$faq->question}}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12 mb-3">
                                        <div class="form-group">
                                            <label for="slug">Answer </label>
                                            <textarea name="answer" id="answer" class="form-control" cols="30" rows="40" placeholder="Enter Answer"   required>{{$faq->answer}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
